...
1. The robot is an extract robot created with <a href="/robot/extract/robot-actions">recorder mode</a>.
2. The new page has the same structure as the existing page.
3. You want to extract the same data as the existing page.
