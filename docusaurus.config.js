...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      content:
      '<a href="https://www.maxun.dev/blog/pdf-extract-parse" target="_blank" rel="noopener noreferrer">Introducing PDF Extract & Parse - Easily extract and parse PDF content. Learn more →</a>',
