...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      content:
      '<a href="https://www.maxun.dev/blog/secure-extract" target="_blank" rel="noopener noreferrer">Introducing Maxun CLI - Turn any website into an API from your terminal. Learn more →</a>',
